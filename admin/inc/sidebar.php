 ...
 <div class="aside">
    <div class="profile">
      ...
      <h3 class="name">轻狂书生</h3>
    </div>
    <ul class="nav">
      <li <?php echo $current_page ==='index'?' class="active"' : '' ?>>
        <a href="index.php"><i class="fa fa-dashboard"></i>仪表盘</a>
      </li>
      <?php $memu_post=array('posts','post-add','categories'); ?>
      <li <?php echo in_array($current_page, $memu_post)?'class="active"':''; ?>>
        <a href="#menu-posts"  <?php echo in_array($current_page,$memu_post)?'':'class="collapsed"'; ?> data-toggle="collapse">
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-posts" class="collapse <?php echo in_array($current_page,$memu_post)?' in':''?>">
      ...
      <li <?php echo $current_page=== 'users'?'class="active"' : ''; ?>>
       ...
       <?php $memu_settings=array('nav-menus','slides','settings'); ?>
      <li>
        <a href="#menu-settings" class="collapsed" <?php in_array($current_page,$memu_settings)?'':'class="collapsed"' ?> data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        
        <ul id="menu-settings" class="collapse <?php echo in_array($current_page,$memu_settings)?' in':''?>">
