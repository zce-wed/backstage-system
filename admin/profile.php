    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="email" class="form-control" name="email" type="type" value="admin@zce.me" placeholder="邮箱" readonly>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="nickname" class="form-control" name="nickname" type="type" value="轻狂书生" placeholder="昵称">
